...
public class Hockey03 {
  public static void main(String[] args) {
    ...
    OptionalInt min = table.stream().mapToInt(clubHockey::getSavedShotsOnGoalFor).min();
    if (min.isPresent()) {
      System.out.printf("Lowest number of Saved Shots on Goals : %d\n", min.getAsInt());
    } else {
