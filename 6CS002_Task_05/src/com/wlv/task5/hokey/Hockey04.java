...
public class Hockey04 {
  public static void main(String[] args) {
    ...
    System.out.println("Several clubs have 5 points");
    table.stream().filter(club -> club.getSavedShotsOnGoalFor() == 5)
        .forEach(System.out::println);

    System.out.println();
    System.out.println("Clubs with 2 points");
    table.stream().filter(club -> club.getSavedShotsOnGoalFor() == 2)
        .forEach(System.out::println);
